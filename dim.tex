...
\begin{theorem}{$3-SAT$ Problem}
	...
	\begin{proof}
		...
		\underline{Conclusione:} Sapendo che $SAT$ è $\mathcal{NP}$-Hard e avendo costruito una riduzione in tempo polinomiale da $SAT$ a $3-SAT$, segue
...
\begin{theorem}{$CLIQUE$ Problem}
	...
	\begin{proof}
		...
		a $CLIQUE$, costruendo (o riducendo) per ogni formula $\phi$ 3-CNF arbitraria un grafo non orientato (dove ogni letterale
		è un nodo e facendo vedere che se i letterali sono della stessa clausola, nel grafo i letterali della 
		stessa clausola non si collegano tra loro); faccio vedere
		che la riduzione funziona perchè $\phi$ è soddisfacibile $\iff$ G ha un $k-clique$ (nella formula k è il numero delle clausole!)
