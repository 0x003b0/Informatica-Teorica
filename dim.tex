...
\begin{theorem}{Acceptance Problem}
	IIl problema dell'accettazione è indecidibile. \\
	$\mathcal{L}_{\text{Acc}} = \{(R(M),w) \mid M \text{ MdT che accetta } w\}$ è indecidibile.
	\footnotesize % riduce la dimensione del font
	\begin{proof}
	\end{proof}
	\end{theorem}
	Il problema dell'accettazione è semidecidibile + indecidibile, oppure, equivalentemente scrivo:
\begin{align*}
	\textcolor{red}{\mathcal{L}_{\text{Acc}} \text{ è semidecidibile ma non decidibile}}
\end{align*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{theorem}{$VERTEX$ $COVER$ Problem}
	...
	\end{proof}
\end{theorem}
\begin{osservazioni}[$VC \in \mathcal{NP}$-Hard]
	\footnotesize
...
\end{theorem}
\subsection{$\mathcal{E}xp$ \& $N \mathcal{E}xp$}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\break
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\vspace*{0.4\textheight}  % metà altezza della pagina
\subsection{$\mathcal{NP}Space$}
\vspace*{0.5\textheight}  % metà altezza della pagina
\subsection{Teorema di Savitch}
\vspace*{0.4\textheight}  % metà altezza della pagina
\subsubsection{$\mathcal{P}Space$-Hard}
\vspace*{0.2\textheight}  % metà altezza della pagina
