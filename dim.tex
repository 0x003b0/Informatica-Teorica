...
\begin{definition}[Polinomio booleano] 
	Un \textcolor{red}{polinomio booleano}/formula booleana $p$ è un'espressione costruita con:
	\begin{itemize}
...
\begin{esercizio}[Esempio]
	\footnotesize
	Date le variabili $\{x_1,x_2,x_3\}$, un polinomio booleano in CNF può essere:
	\[
	p = (x_1 \lor \overline{x_2}) \land (\overline{x_1} \lor x_3)
	\]
\end{esercizio}
